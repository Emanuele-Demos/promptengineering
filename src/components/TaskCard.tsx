import { Bell, Calendar, GripVertical, Paperclip } from 'lucide-react'
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          {category && (
            <div className="mb-2">
              <span
                className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-semibold text-slate-700 bg-slate-100"
