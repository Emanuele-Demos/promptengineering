  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
        ...
        <h1 className="text-xl font-bold text-slate-900">Recupero password</h1>
        <p className="text-slate-500 mt-2 text-sm">
          Il recupero password sarà disponibile in una prossima versione. Contatta
          l&apos;amministratore se hai bisogno di assistenza.
        </p>
        <Link
          to="/login"
